...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `multipartite-graph-lookahead-hybrid` | 316.5 | 2005.6 | 165.3 | 151.3 | 650.5 | 2.27 |
| `multipartite-graph-walk` | 313.6 | 2192.0 | 0.0 | 0.0 | 0.0 | 2.40 |
| `multipartite-graph-lookahead-density` | 311.1 | 3148.3 | 311.1 | 0.0 | 4239.0 | 2.87 |
| `multipartite-graph-lookahead-scarcity` | 307.5 | 3503.1 | 307.5 | 0.0 | 4241.6 | 2.94 |
| `multipartite-graph-lookahead` | 315.8 | 2862.4 | 299.8 | 16.0 | 1214.0 | 2.97 |
| `multipartite-graph-lookahead-hardest-partition` | 308.5 | 3567.0 | 308.5 | 0.0 | 1031.3 | 3.04 |
| `multipartite-graph-lookahead-hardest-seed` | 313.4 | 3800.1 | 313.4 | 0.0 | 4300.9 | 3.05 |
| `multipartite-graph-lookahead-adaptive-penalty` | 312.1 | 3672.6 | 312.1 | 0.0 | 4251.8 | 3.05 |
| `multipartite-graph-lookahead-adaptive` | 318.4 | 2594.4 | 302.3 | 16.1 | 980.4 | 3.15 |
| `multipartite-graph-lookahead-beam-2` | 303.0 | 3662.8 | 303.0 | 0.0 | 4113.8 | 3.17 |
| `multipartite-graph-lookahead-frontier` | 313.5 | 4832.6 | 313.5 | 0.0 | 4277.6 | 3.50 |
| `multipartite-graph-lookahead-beam-3` | 305.6 | 4801.8 | 305.6 | 0.0 | 4145.3 | 3.93 |
...
- Best row count across non-full-factorial cases: `multipartite-graph-lookahead-beam-2`
- Best balanced runtime/rows result: `multipartite-graph-lookahead-density`

| Documented experiment | Avg rows | Avg runtime ms | Avg graph rows | Avg fallback rows | Avg lookahead evals | Balanced score |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `multipartite-graph-lookahead-density` | 311.1 | 3148.3 | 311.1 | 0.0 | 4239.0 | 2.27 |
| `multipartite-graph-lookahead-scarcity` | 307.5 | 3503.1 | 307.5 | 0.0 | 4241.6 | 2.36 |
| `multipartite-graph-lookahead-hardest-seed` | 313.4 | 3800.1 | 313.4 | 0.0 | 4300.9 | 2.40 |
| `multipartite-graph-lookahead-adaptive-penalty` | 312.1 | 3672.6 | 312.1 | 0.0 | 4251.8 | 2.41 |
| `multipartite-graph-lookahead-hardest-partition` | 308.5 | 3567.0 | 308.5 | 0.0 | 1031.3 | 2.43 |
| `multipartite-graph-lookahead-beam-2` | 303.0 | 3662.8 | 303.0 | 0.0 | 4113.8 | 2.59 |
| `multipartite-graph-lookahead-frontier` | 313.5 | 4832.6 | 313.5 | 0.0 | 4277.6 | 2.68 |
| `multipartite-graph-lookahead-beam-3` | 305.6 | 4801.8 | 305.6 | 0.0 | 4145.3 | 3.02 |
